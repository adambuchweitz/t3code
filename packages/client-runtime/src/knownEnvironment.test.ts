...
describe("scoped refs", () => {
  const environmentId = "environment-test" as typeof EnvironmentId.Type;
  const projectId = "project-1" as typeof ProjectId.Type;
  const threadId = "thread-1" as typeof ThreadId.Type;
